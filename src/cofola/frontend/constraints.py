"""Constraint definitions for the Cofola frontend core problem model.
...
class ForAllParts:
    ...
    ``part_ref`` points at the scoped PartPlaceholderDef used inside the
    template; lowering replaces that placeholder with each concrete part.
    """

    constraint_template: Constraint
    partition: ObjRef
    part_ref: ObjRef | None = None
